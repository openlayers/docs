...
used code in OpenLayers 2. Any time you see the string "EPSG:4326", you can 
...
Thankfully, OpenLayers 2 now provides tools to help you reproject your data
...
OpenLayers 2 supports, including WKT, GeoJSON, KML and others. Simply specify
...
transformed before adding to the layer. OpenLayers 2 will only transform the
...
--------------------------
The way to serialize vector data in OpenLayers 2 is to take a collection of data
...
projected. To prevent user confusion, OpenLayers 2 allows one to set a
...
The SphericalMercator projection in OpenLayers 2 uses code EPSG:900913. Many
...
official EPSG code with an OpenLayers 2 SphericalMercator layer, you have to make
sure that OpenLayers 2 requests EPSG:3857 or other alias in stead of EPSG:900913.
