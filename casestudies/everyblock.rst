...
With OpenLayers 2, on the other hand, EveryBlock gets complete control: over
styling, data, restrictions on usage, and more. Using OpenLayers 2, EveryBlock
...
custom tile generation/serving routine later on. OpenLayers 2 was able to
...
Another benefit of using the OpenLayers 2 library was the ability to quickly and
...
In addition to using built in functionality in OpenLayers 2, EveryBlock has been
able to extend OpenLayers 2 for displaying large quantities of data, using custom
server side tools to create clusters of data. Using OpenLayers 2 vector styling,
...
stories, photos, and more. By using the functionality in OpenLayers 2, EveryBlock
is able to create compelling maps that tell stories, within the limited
framework of the browser.

As EveryBlock has grown, its use of OpenLayers 2 has changed. Paul Smith
continues to support the use of OpenLayers 2 for EveryBlock, saying that
"OpenLayers 2 is sophisticated enough by default for many applications, but its
...
Using OpenLayers 2 provided EveryBlock the functionality they needed in order to
...
OpenLayers 2 and Mapnik with open data from the US Government to build a
compelling mapping base layer. The ability to extend OpenLayers 2 for support of
new datasources, and use advanced OpenLayers 2 functionality like vector drawing
