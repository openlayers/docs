...
OpenLayers 2 Examples
-------------------

.. _`OpenLayers 2 Examples`: http://dev.openlayers.org/examples/
...
------------------
 ...
 `API Docs`_
  Documentation for the OpenLayers 2 API
 `Developer Docs`_
  Developer Documentation for the OpenLayers 2 API
